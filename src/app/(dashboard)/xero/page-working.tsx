...
export default function XeroPage() {
  ...
  return (
    <div className="p-6">
        ...
        <div className="relative z-10">
          ...
          <div className="mt-3 flex items-center gap-4">
            <span className="bg-blue-600/80 backdrop-blur-sm px-3 py-1 rounded-full text-sm text-white shadow-lg border border-white/20">
              📊 Data Source: {Object.keys(budgetData).some(k => budgetData[k].length > 0) ? 'Budget Management System' : 'Demo Data'}
            </span>
            <button
      ...
      {/* Centre Accordions */}
      {Object.keys(budgetData).length === 0 || !Object.keys(budgetData).some(k => budgetData[k].length > 0) ? (
